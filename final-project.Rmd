...
Healthy Life Expectancy: Healthy life expectancy is a score calculated by comparing the number of years by which a country's life expectancy is greater than that of the lowest country. Life expectancy data was extrapolated from the WHOs health observation data up to 2016. Where missing, life expectancy data for certain countries was found using research and government tools [3][4]. 
