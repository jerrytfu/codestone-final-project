...
Freedom to Make Life Choices: Freedom to make Life Choices is a self-reported measure of whether or not respondents feel they can do what they want with their lives. Respondents were asked, “Are you satisfied or dissatisfied with your freedom to choose what you do with your life?” and responded with 0 or 1 (no or yes). The average for each respective country or region creates this value [3][4].
...
Next, we ask the question: "Is there a relationship between region of the world
and happiness score?" Hence, we must know if there is an association between the
region in the world one lives in and the happiness score for that region. We
used a chi-square test of independence to determine whether the relationship
between the two aforementioned variables is statistically significant.

As happiness score is a quantitative variable, to implement the chi-square 
test, we must first group happiness scores into distinct categories. However,
selecting arbitrary ranges to define as happy vs. unhappy offers varied results;
thus, we create 4 ranges based on IQR.
...
a country's overall happiness. Here, we plot happiness scores, GDP scores, 
Social Support score, Life Expectancy score, Freedom to make Life Choices score,
Generosity score, and Perceptions of Corruption score.
...
#### Chi-square test
With our simulated p-value of 0.1124 which is less than our $\alpha = 0.05$, we do not have
sufficient evidence to reject the null hypothesis in favor of the alternative hypothesis
and conclude that there is an association between which region of the world a country is in and happiness score. This might be because the distribution of happiness score across regions are not different enough to show an association between region and happiness.
