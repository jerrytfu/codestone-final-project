...
bootstrap <- diff_means(variable = "GDP_per_capita", 100)
...
bootstrap <- diff_means(variable = "Social_support", 100)
...
bootstrap <- diff_means(variable = "Freedom_to_make_life_choices", 100)
...
bootstrap <- diff_means(variable = "Generosity", 100)
...
worldhappiness %>%
  filter(Region == "North America and ANZ") %>%
  summarize(NA_life_expectancy = mean(Healthy_life_expectancy))

bootstrap <- diff_means(variable = "Healthy_life_expectancy", 100)
...
worldhappiness %>% 
  filter(Region == "Western Europe") %>%
  summarize(WE_POC = mean(Perceptions_of_corruption))

worldhappiness %>%
  filter(Region == "North America and ANZ") %>%
  summarize(NA_POC = mean(Perceptions_of_corruption))

bootstrap <- diff_means(variable = "Perceptions_of_corruption", 100)
...
Since the calculated p-value of 0.11 is not significant at the $\alpha =$ 0.05 level, we fail to reject the null hypothesis. Therefore, there is not statistically significant evidence to suggest that the mean GDP per capita score in Western Europe is greater than that of North America. 

#### Social support:

The calculated p-value of 0.06 is not significant at the $\alpha =$ 0.05 level, so we fail to reject the null hypothesis. Therefore, there is not statistically significant evidence to suggest that the mean social support score in Western Europe is greater than that of North America.

#### Freedom to make life choices

Since the calculated p-value of 0.06 is not significant at the $\alpha =$ 0.05 level, we fail to reject the null hypothesis. Therefore, there is not statistically significant evidence to suggest that the mean freedom to make life choices score in Western Europe is greater than that of North America. 
...
The calculated p-value of 0.01 is significant at the $\alpha =$ 0.05 level, so we can the null hypothesis. Therefore, there is statistically significant evidence to suggest that the mean life expectancy score in Western Europe is greater than that of North America. 
